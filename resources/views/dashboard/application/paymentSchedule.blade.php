...
<div class="modal fade bs-example-modal-center"   id="paymentSchedule" tabindex="-1" aria-labelledby="myLargeModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            {{ Form::open(['route' => ['application.payment.schedule.store']]) }}
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-6">
                        <div class="form-group{{ $errors->has('client_name') ? ' has-error' : '' }} mb-3">
                            ...
                            <div class="col-sm-12">
                                {{ Form::text('client_name', $client->first_name,  ['class' => 'form-control','placeholder' => 'Enter client name','id'=>'client_name', 'readonly']) }}
                    ...
                    <div class="col-6">
                        <div class="form-group{{ $errors->has('application') ? ' has-error' : '' }} mb-3">
                            ...
                            <div class="col-sm-12">
                                {{ Form::text('application', $application->product->name, ['class' => 'form-control','placeholder' => 'Enter application','id'=>'application', 'readonly']) }}
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }} mb-3">
                            {{ Form::label('amount', 'Installment Amount', ['class' => 'col-sm-12 control-label','for'=>'installment_date']) }}
                            <div class="col-sm-12">
                                {{ Form::text('amount', null, ['class' => 'form-control','placeholder' => 'Enter Installment Amount','id'=>'installment_date', 'required']) }}
