<table id="datatable" class="table table-striped table-bordered dt-responsive nowrap">
    ...
    @foreach ($statuses as $status)
        <tr>
            ...
            <td>{{ $status->name }}</td>
            <td nowrap="nowrap">
                {{-- <a class="btn btn-info" href="{{ route('status.show', $status->id) }}"><i class="fas fa-eye"></i></a> --}}
                {{-- Edit Modal --}}
                ...
                <div id="edit{{$status->id}}" class="modal fade" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            {{ Form::model($status, ['route' => ['status.update', $status->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
