    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="createLabel">Create Partner</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    {{ Form::open(['route' => 'partner.store', 'class' => 'needs-validation', 'novalidate','files' => true ]) }}
                ...
                <div class="card">
                    <div class="card-body">
                        @include('dashboard.partner.partnerTable')
                    </div>
                </div>
            </div> <!-- end col -->
        </div>
