    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="createLabel">Create Enquiry</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    {{ Form::open(['route' => 'enqury.store', 'class' => 'needs-validation', 'novalidate']) }}
                ...
                <div class="card">
                    <div class="card-body">
                        @include('dashboard.enqury.enquryTable')
                    </div>
                </div>
            </div> <!-- end col -->
        </div>
