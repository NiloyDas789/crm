    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="createLabel">Create Office</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    {{ Form::open(['route' => 'office.store', 'class' => 'needs-validation','files' => true, 'novalidate']) }}
                ...
                <div class="card">
                    <div class="card-body">
                        @include('dashboard.office.officeTable')
                    </div>
                </div>
            </div> <!-- end col -->
        </div>
