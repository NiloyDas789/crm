<table id="datatable" class="table table-striped table-bordered dt-responsive nowrap">
    ...
    @foreach ($cities as $city)
        <tr>
            ...
            <td>{{ $city->name }}</td>
            <td nowrap="nowrap">
                {{-- <a class="btn btn-info" href="{{ route('city.show', $city->id) }}"><i class="fas fa-eye"></i></a> --}}
                {{-- Edit Modal --}}
                <button type="button" class="btn btn-primary btn-md waves-effect waves-light"
                        data-bs-toggle="modal" data-bs-target="#edit{{$city->id}}"><i
                        class="fas fa-edit"></i></button>
                <!-- sample modal content -->
                <div id="edit{{$city->id}}" class="modal fade" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            {{ Form::model($city, ['route' => ['city.update', $city->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
