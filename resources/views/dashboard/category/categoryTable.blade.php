<table id="datatable" class="table table-striped table-bordered dt-responsive nowrap">
    ...
    @foreach ($categories as $category)
        <tr>
            ...
            <td>{{ $category->name }}</td>
            <td nowrap="nowrap">
                {{-- <a class="btn btn-info" href="{{ route('category.show', $category->id) }}"><i class="fas fa-eye"></i></a> --}}
                {{-- Edit Modal --}}
                ...
                <div id="edit{{$category->id}}" class="modal fade" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            {{ Form::model($category, ['route' => ['category.update', $category->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
