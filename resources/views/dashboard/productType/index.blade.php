    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">ProductType</h4>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="createLabel">Create ProductType</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    {{ Form::open(['route' => 'productType.store', 'class' => 'needs-validation', 'novalidate']) }}
                ...
                <div class="card">
                    <div class="card-body">
                        @include('dashboard.productType.productTypeTable')
                    </div>
                </div>
            </div> <!-- end col -->
        </div>
